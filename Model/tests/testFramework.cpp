...
//     {
//         string configs = FilePathHelper::Combine(path,
//         "run_modes/pull_configs.json");
...
// {
//     string coorFile = FilePathHelper::Combine(parent,
//     "rainfall_model/coordinates.csv"); string rainFile =
//     FilePathHelper::Combine(parent, "rainfall_model/rainfall.csv");
...
//     for (auto &id : lIds)
//     {
//         auto src_id = jLoader.GetValue<string>({"links", id},
//         "source_model").value(); auto tar_id = jLoader.GetValue<string>({"links",
...
//         int src_element_size = jLoader.GetArraySize({"links", id,
//         "source_elementset"}); unordered_map<string, string> src_elements; for (int i
//         = 0; i < src_element_size; i++)
//         {
//             auto eId =
//                 jLoader.GetValue<string>({"links", id, "source_elementset"}, i,
//                 "id");
//             auto type =
//                 jLoader.GetValue<string>({"links", id, "source_elementset"}, i,
//                 "type");
...
//         int tar_element_size = jLoader.GetArraySize({"links", id,
//         "target_elementset"}); unordered_map<string, string> tar_elements; for (int i
//         = 0; i < tar_element_size; i++)
//         {
//             auto eId =
//                 jLoader.GetValue<string>({"links", id, "target_elementset"}, i,
//                 "id");
//             auto type =
//                 jLoader.GetValue<string>({"links", id, "target_elementset"}, i,
//                 "type");
...
//             auto src_state =
//                 jLoader
//                     .GetValue<string>({"links", id, "data_exchanged"}, i,
//                     "src_state") .value();
//             auto src_element =
//                 jLoader
//                     .GetValue<string>(
...
//         auto sAdaptor     = sFactory->CreateAdaptedOutput(sAdaptorId, tAdaptor,
//         input);
